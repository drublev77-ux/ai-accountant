...
export const Route = createFileRoute("/")({
	component: () => (
		<ThemeProvider defaultTheme="system" storageKey="ai-accountant-theme">
			<Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center">
...
function App() {
	...
	return (
		<div key={i18n.language} className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 relative overflow-hidden transition-colors duration-300">
			{/* Animated background elements */}
			<div className="absolute inset-0 overflow-hidden pointer-events-none">
				<div className="absolute top-20 right-20 w-96 h-96 bg-purple-300/20 dark:bg-purple-600/10 rounded-full blur-3xl animate-pulse"></div>
				<div className="absolute bottom-20 left-20 w-80 h-80 bg-pink-300/20 dark:bg-pink-600/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
			</div>

			<header className="bg-gradient-to-r from-white/80 via-purple-50/80 to-pink-50/80 dark:from-slate-900/90 dark:via-slate-800/90 dark:to-slate-900/90 backdrop-blur-xl border-b border-purple-200/50 dark:border-slate-700/50 shadow-lg shadow-purple-200/50 dark:shadow-slate-900/50 sticky top-0 z-50 transition-colors duration-300">
					...
					<div className="flex items-center justify-between gap-3 flex-wrap">
						<div className="flex items-center gap-3 group">
							...
							<div>
								...
								<p className="text-sm text-purple-600 dark:text-purple-400 font-medium">{t("app.subtitle")}</p>
							</div>
						</div>
			...
			<main className="container mx-auto px-4 py-6 relative z-10">
				<Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
					<TabsList className="grid w-full grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-9 gap-1.5 h-auto bg-gradient-to-r from-white/80 via-purple-50/80 to-pink-50/80 dark:from-slate-800/90 dark:via-slate-700/90 dark:to-slate-800/90 backdrop-blur-xl border border-purple-200/50 dark:border-slate-700/50 shadow-lg shadow-purple-200/30 dark:shadow-slate-900/30 p-1.5 transition-colors duration-300">
