...
import { FinancialReminderORM, FinancialReminderPriority, type FinancialReminderModel } from "@/components/data/orm/orm_financial_reminder";
...
export function RemindersView() {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		const reminderData = {
			...
			priority: parseInt(formData.priority) as FinancialReminderPriority,
			is_completed: false,
			version: 1,
		};
																...
																<div>
																	...
																	<div className="flex gap-2 mt-2">
																		...
																		<Badge variant="secondary">
																			{reminder.priority === 3 ? "High" : reminder.priority === 2 ? "Medium" : "Low"}
																		</Badge>
																	</div>
																</div>
