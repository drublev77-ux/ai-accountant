...
import { SyncStatusDetails } from "@/components/NetworkStatus";
...
export function SettingsView() {
	...
	return (
		<div className="space-y-6">
			<div>
				<h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100">Settings & Account</h2>
				<p className="text-slate-600 dark:text-slate-400 mt-1">Manage your subscription and app settings</p>
			</div>
