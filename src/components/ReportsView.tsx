...
export function ReportsView() {
	...
	const [generatedReports, setGeneratedReports] = useState<FinancialReportModel[]>([]);
	...
	const reports = generatedReports.sort((a, b) =>
		new Date(b.generated_at).getTime() - new Date(a.generated_at).getTime()
	);
	const reportsLoading = false;

	const saveReport = (reportData: FinancialReportModel) => {
