...
// - Entity Name: user.
// - Entity ID: 102019b161434697d57bc1f0e539b9cf0b7.
...
export class UserORM {
  ...
  private constructor() {
    ...
    this.entityId = '102019b161434697d57bc1f0e539b9cf0b7';
...
function UserModelToValues(data: UserModel): Value[] {
  const fieldMappings = [
    ...
    { key: 'oauth_tokens', type: DataType.string, defaultValue: null },
    { key: 'preferences', type: DataType.string, defaultValue: null },
  ];
  ...
  for (const value of values) {
    ...
    switch (value.name) {
      ...
      case 'password_hash':
        ...
        break;
      case 'oauth_tokens':
        data.oauth_tokens = ParseValue(value, DataType.string) as string | null;
        break;
      case 'preferences':
        data.preferences = ParseValue(value, DataType.string) as string | null;
        break;
    }
  }
